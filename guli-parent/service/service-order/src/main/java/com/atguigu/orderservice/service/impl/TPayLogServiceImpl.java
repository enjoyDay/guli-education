...
public class TPayLogServiceImpl extends ServiceImpl<TPayLogMapper, TPayLog> implements TPayLogService {
    ...
    public void updateOrdersStatus(Map<String, String> map) {
        ...
        Map<String, Object> data = eduClient.getCourseById(courseId).getData();
        EduCourseVo eduCourse = JSON.parseObject(JSON.toJSONString(data.get("eduCourse")), EduCourseVo.class);
        eduCourse.setBuyCount(eduCourse.getBuyCount() + 1);
        eduClient.updateCourse(eduCourse);
